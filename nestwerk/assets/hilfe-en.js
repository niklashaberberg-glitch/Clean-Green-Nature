...
(function (NW) {
  ...
  const THEMEN_EN = [
    /* ---------------- Plans and money ---------------- */
    {
      ...
      antwort: () => {
        ...
        return 'The search is completely free: every listing, the map, matching, the fraud check notice, '
          ...
          + 'Nestwerk Plus costs ' + U.eur2(t.preisMonat) + ' a month or ' + U.eur2(t.preisJahr)
          ...
          + 'and no ads.\n\n'
          + 'The first ' + U.num(NW.plan.GRUENDER.plaetze) + ' sign-ups get Plus free for twelve months '
      ...
      antwort: () => {
        ...
        if (q === 'gruender') {
          return 'On this device Plus runs on a founder place – that is not a subscription. It does not '
            ...
            + NW.plan.gruenderTageRest() + ' days it ends by itself.\n\n'
    ...
    },
    {
      ...
      antwort: () => {
        const preise = NW.plan.HERVORHEBUNG.map((x) => U.t(x.name) + ' ' + U.eur2(x.preis)).join(', ');
        return 'Three options, for a fee: ' + preise + '. '
          + Math.round(NW.plan.PLUS_RABATT * 100) + ' % cheaper with Plus.\n\n'
    ...
    /* ---------------- Applying ---------------- */
    {
      ...
      antwort: 'Every listing page has “Write” (for a purchase: “Enquire”). Nestwerk drafts a suggestion '
    ...
    },
    {
      ...
      antwort: 'Every listing page carries an honest estimate: how many interested parties there are, how '
        ...
        + 'and a realistic budget. If your search lets almost nothing through, Nestwerk shows below the '
    ...
    },
    {
      ...
      antwort: () => 'Set your filters in the search, then save them under “Saved searches”. New results '
        ...
        + NW.plan.GRENZEN.frei.suchauftraege + ' saved search, Plus as many as you like. Anyone searching '
    ...
    },
    {
      ...
      antwort: 'In a direct swap two people have to want exactly the opposite of each other – which '
        ...
        + 'Nestwerk searches every offer automatically for such closed chains. The “Swap chains” page '
    ...
    /* ---------------- Law and protection ---------------- */
    {
      ...
      antwort: 'Nestwerk flags the usual patterns by itself: a conspicuously low price, a provider '
    ...
    },
    {
      ...
      antwort: 'Every listing is set against the local benchmark rent (ortsübliche Vergleichsmiete), with '
        ...
        + 'the local benchmark. Nestwerk shows where that might apply and how much would then be lawful. '
    ...
    },
    {
      ...
      antwort: 'Nestwerk computes entirely in your browser. Your profile, saved list, saved searches, '
  ...
  NW.hilfe.themenEintragen('en', THEMEN_EN);
})(window.NW = window.NW || {});
