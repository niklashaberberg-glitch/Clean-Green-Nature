/* =====================================================================
   Nestwerk – Hilfe: Wissensbasis und Abgleich
...
(function (NW) {
  ...
  const THEMEN = [
    /* ---------------- Tarif und Geld ---------------- */
    {
      ...
      antwort: () => {
        ...
        return 'Die Suche ist vollständig kostenlos: alle Inserate, Karte, Passung, Prüfhinweis gegen Betrug, '
          ...
          + 'Nestwerk Plus kostet ' + U.eur2(t.preisMonat) + ' im Monat oder ' + U.eur2(t.preisJahr)
          ...
          + 'Die ersten ' + U.num(NW.plan.GRUENDER.plaetze) + ' Anmeldungen bekommen Plus zwölf Monate '
      ...
      antwort: () => {
        ...
        if (q === 'gruender') {
          return 'Auf diesem Gerät läuft Plus über einen Gründerplatz – das ist kein Abo. Es verlängert sich '
            ...
            + NW.plan.gruenderTageRest() + ' Tagen endet es von selbst.\n\n'
    ...
    },
    {
      ...
      antwort: () => {
        const preise = NW.plan.HERVORHEBUNG.map((x) => x.name + ' ' + U.eur2(x.preis)).join(', ');
        return 'Drei Möglichkeiten, gegen Gebühr: ' + preise + '. Mit Plus '
          + Math.round(NW.plan.PLUS_RABATT * 100) + ' % günstiger.\n\n'
    ...
    /* ---------------- Bewerben ---------------- */
    {
      ...
      antwort: 'Auf jeder Objektseite steht „Anschreiben“ (beim Kauf: „Anfragen“). Nestwerk schreibt daraus '
    ...
    },
    {
      ...
      antwort: 'Auf jeder Objektseite steht eine ehrliche Einschätzung: wie viele Interessenten es gibt, wie '
        ...
        + 'ein realistisches Budget. Wenn die Suche fast nichts durchlässt, zeigt Nestwerk unter den Treffern, '
    ...
    },
    {
      ...
      antwort: () => 'Filter in der Suche einstellen, dann unter „Suchaufträge“ speichern. Neue Treffer '
        ...
        + NW.plan.GRENZEN.frei.suchauftraege + ' Auftrag möglich, mit Plus beliebig viele. Wer in mehreren '
    ...
    },
    {
      ...
      antwort: 'Beim direkten Tausch müssen zwei Menschen genau das Gegenteil voneinander wollen – das '
        ...
        + 'Nestwerk durchsucht alle Angebote automatisch nach solchen geschlossenen Ketten. Auf der Seite '
    ...
    /* ---------------- Recht und Schutz ---------------- */
    {
      ...
      antwort: 'Nestwerk markiert die typischen Muster von selbst: auffällig niedriger Preis, Anbieter '
    ...
    },
    {
      ...
      antwort: 'Jedes Inserat wird gegen die ortsübliche Vergleichsmiete gestellt, mit dem Abstand in Prozent.\n\n'
        ...
        + 'der ortsüblichen Vergleichsmiete liegen. Nestwerk zeigt, wo das greifen könnte und wie viel dann '
    ...
    },
    {
      ...
      antwort: 'Nestwerk rechnet vollständig in deinem Browser. Profil, Merkliste, Suchaufträge, Nachrichten '
