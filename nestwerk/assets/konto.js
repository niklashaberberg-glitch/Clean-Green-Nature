/* =====================================================================
   ...
   Nestwerk-Seite nachbaut und Zugangsdaten abfischt, bekommt mit einem
...
(function (NW) {
  ...
  const SPEICHER = 'nestwerk.konto.v1';
  ...
  const ANBIETER = [
    {
      ...
      erklaerung: 'Der Schlüssel entsteht im Sicherheitschip deines Geräts und verlässt ihn nie. Er ist an '
        + 'nestwerk.de gebunden: Eine nachgebaute Seite bekommt nichts, selbst wenn du darauf hereinfällst. '
    ...
    },
    {
      ...
      farbe: '#1a73e8',
      stufe: 2,
      erklaerung: 'Nestwerk erfährt von Google deinen Namen, deine E-Mail-Adresse und dass sie bestätigt ist. '
        + 'Kein Zugriff auf Kontakte, Kalender oder Dateien, und dein Google-Passwort bekommt Nestwerk nie zu '
        + 'sehen.',
    ...
    },
    {
      ...
      farbe: '#0067b8',
      stufe: 2,
      erklaerung: 'Nestwerk erfährt Name und E-Mail-Adresse aus deinem Microsoft-Konto. Sonst nichts – kein '
    ...
    },
    {
      ...
      farbe: '#111111',
      stufe: 2,
      erklaerung: 'Apple erlaubt es, die eigene Adresse zu verbergen: Nestwerk bekommt dann eine '
  ...
  function passkeyAnlegen(name) {
    ...
    return navigator.credentials.create({
      publicKey: {
        ...
        challenge: zufall(32),
        rp: { name: 'Nestwerk' },
        user: { id: nutzerId, name: name || 'nestwerk', displayName: name || 'Nestwerk-Konto' },
  ...
  function anmelden(daten) {
    ...
    const k = Object.assign({
      ...
      angelegt: (vorher && vorher.angelegt) || U.isoDate(NW.now()),
