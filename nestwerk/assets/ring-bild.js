/* =====================================================================
   Nestwerk – Der Ringtausch als Bild
  ...
  const SCHRITTE = [
    ...
    },
    {
      ...
      text: 'Eine Kette funktioniert nur geschlossen: Jede Wohnung wird frei, weil eine andere frei wird. '
        + 'Deshalb liegen die Umzüge beieinander. Nestwerk sucht solche geschlossenen Ketten über zwei, drei '
    ...
    },
    {
      ...
      text: 'Ein Ring ist rechtlich kein Tausch, sondern für jede Wohnung ein neuer Mietvertrag. Und er steht '
        + 'und fällt mit den Zustimmungen. Nestwerk zeigt bei jeder gefundenen Kette, wie viele davon schon '
        + 'vorliegen und welches Glied das schwächste ist.'
    }
  ];

  NW.ringBild = { SCHRITTE, bildDirekt, bildKette, bildUmzug, bildBedingungen, LEUTE };
})(window.NW = window.NW || {});
