/* =====================================================================
   Nestwerk – Anmeldung und Konto: Oberfläche
...
(function (NW) {
  ...
  const U = NW.util, ui = NW.ui, K = NW.konto, R = NW.recht;
  ...
  function wahlSchritt() {
    return h`<div class="anmeldung__wege">
      ...
      <details class="anmeldung__warum">
        ...
        <p>Bei Google, Microsoft und Apple bekommt Nestwerk Name und E-Mail-Adresse, dein Passwort dort aber
    ...
    return h`<div class="anmeldung__form">
      ...
      <div class="anmeldung__zustimmung">
        <p class="anmeldung__zustimmungKopf">
          ...
          <b>Nestwerk möchte auf dein Konto zugreifen</b>
        </p>
        <ul class="pruef">
          ...
          <li>${ico('x')}<span>Dein Passwort bekommt Nestwerk nie zu sehen</span></li>
        </ul>
        ${a.id === 'apple' ? h`<label class="schalter">
          <input type="checkbox" id="anmelden-verbergen" checked>
          <span><b>E-Mail-Adresse verbergen</b>
            <i>Nestwerk bekommt eine Weiterleitungsadresse statt deiner echten.</i></span></label>` : ''}
          ...
          <div class="anmeldung__ehrlich">
            ...
            <div>
              ...
              <p>Ein Konto ist überall in zwei Minuten angelegt. Was wirklich hilft, ist die Stufe darüber –
                ...
                und dass man <b>sieht</b>, welche Stufe das Gegenüber hat. Nestwerk zeigt das an jedem Inserat.</p>
            </div>
          </div>
        </div>
  ...
  function passkeyAnmelden() {
    ...
    const arbeit = vorhanden ? K.passkeyPruefen(vorhanden) : K.passkeyAnlegen('Nestwerk');
    arbeit.then((erg) => {
      if (vorhanden) {
  ...
  NW.viewAnmeldung = { anmeldeseite, kontoseite };
})(window.NW = window.NW || {});
