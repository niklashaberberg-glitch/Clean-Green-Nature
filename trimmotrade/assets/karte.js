...
(function (TT) {
  ...
  function Karte(container, optionen) {
    ...
    container.innerHTML =
      '<svg class="karte__svg" viewBox="0 0 ' + W + ' ' + H + '" role="application" aria-label="' + TT.util.t('Karte der Suchergebnisse') + '" tabindex="0">' +
      '<defs>' +
      ...
      '<span><i style="background:' + FARBEN.miete + '"></i>' + TT.util.t('Miete') + '</span>' +
      '<span><i style="background:' + FARBEN.kauf + '"></i>' + TT.util.t('Kauf') + '</span>' +
      '<span><i style="background:' + FARBEN.wg + '"></i>' + TT.util.t('WG') + '</span>' +
      '<span><i style="background:' + FARBEN.tausch + '"></i>' + TT.util.t('Tausch') + '</span>' +
      '</div>' +
