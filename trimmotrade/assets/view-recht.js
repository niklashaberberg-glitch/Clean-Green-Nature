      ...
      html: h`<div class="seite seite--schmal">
        ...
        <div class="block rechtstext">
          ...
          <p>Wählst du einen dieser Wege, erfährt der jeweilige Anbieter, dass du dich bei TrimmoTrade
            ...
            verschieden:</p>
          <dl class="rechtsliste">
            <dt>Google</dt><dd>Name, E-Mail-Adresse und die Angabe, ob sie bestätigt ist</dd>
          ...
          <h3>Wenn die Adresse nachgetragen wird</h3>
          <p>Entsteht ein Konto ohne E-Mail-Adresse – über Instagram oder mit einem Passkey allein –, fordert
            die Anwendung dazu auf, eine nachzutragen. Das ist keine Schikane, sondern die Voraussetzung
            dafür, dass dich überhaupt jemand erreichen kann. Bis dahin lässt sich die Suche benutzen;
            anfragen, inserieren und Termine buchen nicht.</p>
          <p>Gehört die nachgetragene Adresse bereits einem anderen Konto, werden die beiden <b>nicht</b>
            zusammengelegt. Zwei Konten zu verschmelzen hieße, über fremde Inserate, Anfragen und Unterlagen
            zu entscheiden; das erledigt eine Anmeldung nicht nebenbei. Stattdessen erscheint der Hinweis,
            sich mit dieser Adresse anzumelden.</p>
