...
(function (TT) {
  ...
  const U = TT.util, ui = TT.ui, S = TT.store, W = TT.werkzeuge, A = TT.analyse, P = TT.plan;
  ...
  function leistbarkeitErgebnis() {
    ...
    if (!e.netto) return h`<p class="info-meldung">${ico('info')}Trag dein Nettoeinkommen ein, dann rechnet TrimmoTrade.</p>`;
      ...
      html: h`<div class="seite seite--schmal">
        ...
        <div class="hinweisbox">${ico('warnung')}
          ...
          <p>Sie unterscheidet sich erheblich – manche Länder liegen deutlich über dem Bundesrahmen, viele kennen
            zusätzliche Stufen für höhere Einkommen. TrimmoTrade rechnet deshalb nicht heimlich mit einer Zahl:
  ...
  TT.viewWerkzeuge = { malen, reglerText, KATALOG };
})(window.TT = window.TT || {});
