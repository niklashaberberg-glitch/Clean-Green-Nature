/* =====================================================================
   TrimmoTrade – Werkzeuge, zweiter Teil
...
(function (TT) {
  ...
  const U = TT.util, ui = TT.ui, S = TT.store, W = TT.werkzeuge;
  const h = U.html, raw = U.raw, ico = U.svg;
  const malen = TT.viewWerkzeuge.malen;
        ...
        <form class="block" data-tu-submit="nichts">
          ...
          <div class="formraster">
            ...
            <label class="feld"><span>Datum</span>
              <input type="date" value="${p.datum || U.isoDate(TT.now())}" data-tu-change="prot" data-feld="datum"></label>
