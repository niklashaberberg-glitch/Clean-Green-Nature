/* =====================================================================
   TrimmoTrade – Rechenkerne der Werkzeuge
   ...
   Zahlen setzen, rechnet TrimmoTrade nicht heimlich mit einer davon,
...
(function (TT) {
  ...
  function chancen(l, profil) {
    ...
    /* Ohne Angaben weiß TrimmoTrade nichts – und tut dann besser so, als
    ...
    if (l.kind !== 'kauf' && p.nettoEinkommen) {
      ...
      tipps.push('Trag dein Nettoeinkommen im Profil ein – ohne diese Zahl kann TrimmoTrade deine Chancen nicht einschätzen.');
    }
    ...
    if (kenntNichts) {
      return {
        ...
        tipps: ['Trag Einkommen und vorhandene Unterlagen im Profil ein – danach kann TrimmoTrade deine Chancen wirklich einschätzen.']
        ...
        stufe: 'unbekannt',
        satz: U.t('Über deine Bewerbung weiß TrimmoTrade noch nichts – ohne Einkommen und Unterlagen im Profil '
  ...
  function duplikate(l, alle) {
    const kandidaten = (alle || TT.data.listings).filter((x) => {
  ...
  /* Die Einkommensgrenzen setzen die Länder selbst und weichen teils
     erheblich voneinander ab. TrimmoTrade rechnet deshalb nicht heimlich
  ...
  /* Die Höhe folgt einer Formel mit Beiwerten, die sich je nach
     ...
     Zahl daraus zu erfinden wäre schlimmer als keine. TrimmoTrade prüft
  ...
  function wohngeldPruefung(angaben) {
    ...
    if (gruende.length) {
      ...
      ergebnis = 'unklar';
      satz = 'Trag Bruttoeinkommen und Warmmiete ein, dann ordnet TrimmoTrade das ein.';
